...
<!-- ======================================================================
                                        ...
                                        <div class="content">
                                            <div class="container">
                                                <?php $cecart=mysqli_query($con,"SELECT * FROM cart where id_user='$_SESSION[id_user]' ");if($cecart!=NULL){ ?>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <?php if($cc==NULL) { ?>
                                                                            ...
                                                                            <input class="input-line" type="text" name="id_checkout" value="<?php echo substr(md5(rand()), 0,5); ?>" readonly>
                                                                        <?php } else { ?>
                                                                            <p>Kode CheckOut <span class="neccesary">*</span></p>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <p>Alamat <span class="neccesary">*</span></p>
                                                                        <input type="text" name="alamat" class="input-line" value="<?php echo $cc['alamat']; ?>" autocomplete="off">
                                                                    </div>
                                                                </div>
...
<?php if($cc!=NULL) { ?>
    <div class="col-md-6">
        ...
        <form class="login-form">
            ...
            <p><a class="btn btn-danger" href="cetak.php" class="button-7">Cetak Struk</a></p>
        </form>
    </div>
</div><br>
<div class="col-md-6">
