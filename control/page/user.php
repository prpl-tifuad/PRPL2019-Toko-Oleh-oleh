...
<?php $sqli=mysqli_query($con,"SELECT * FROM user order by username asc");$vr=1;while($val=mysqli_fetch_array($sqli)){ ?>
      ...
      <?php } ?>
                  ...
                  <td align="center"><a href="prosescon/hancon?thisposition=<?php echo base64_encode('deleteuser'); ?>&thiscontrol=<?php echo base64_encode($val['id_user']); ?>" class="btn btn-circle btn-danger btn-sm tip-top" data-toggle="tooltip" data-original-title="Hapus" onclick="return confirm('Yakin Menghapus Data Ini')"><i class="glyphicon glyphicon-remove"></i></a></td>
                </tr>
<?php $vr++; } ?>
                </tfoot>
              </table>
