<?php if(empty($_GET['thisaction'])){header('location:../main');} ?>
      ...
      <ul class="nav nav-tabs">
        <li class="active"><a href="#adminlist" data-toggle="tab">Admin</a></li>
        <li class=""><a href="#newadmin" data-toggle="tab">Add Admin</a></li>
      </ul>
      <div class="tab-content">
        <div class="tab-content">
        <div class="tab-pane active" id="adminlist">
          <br>
          <div class="box-body">
...
<div class="col-md-4">
        <div class="modal-body">
          <form role="form" method="post" action="prosescon/hancon?thisposition=<?php echo base64_encode('addadmin'); ?>">
