...
<?php $user=mysqli_num_rows(mysqli_query($con,"SELECT * from user")); ?>
            ...
            <a href="main?thisaction=<?php echo base64_encode('akunuser'); ?>" class="small-box-footer">Customer</a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-md-4 col-xs-12">
...
<?php $cart=mysqli_num_rows(mysqli_query($con,"SELECT * from cart")); ?>
            ...
            <a href="main?thisaction=<?php echo base64_encode('cart'); ?>" class="small-box-footer">All Cart</a>
          </div>
        </div>
        <div class="col-lg-3 col-md-4 col-xs-12">
          <!-- small box -->
...
<?php $check=mysqli_num_rows(mysqli_query($con,"SELECT * FROM checkout")); ?>
            ...
            <a href="main?thisaction=<?php echo base64_encode('checkout'); ?>" class="small-box-footer">All Checkout</a>
          </div>
        </div>
...
<?php $log=mysqli_num_rows(mysqli_query($con,"SELECT * FROM log")); ?>
            ...
            <a href="#" class="small-box-footer">All Log</a>
          </div>
        </div>
        <!-- ./col -->
