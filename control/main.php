            ...
            <?php while($hcpen=mysqli_fetch_array($cpen)){ $gu=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM user where id_user='$hcpen[id_user]' ")); ?>
                  <li><!-- start message -->
                    ...
                    <?php } ?>
                      ...
                      <p>a.n : <?php echo $hcpen['an']; ?> (Rp. <?php echo rp($hcpen['ongcart']+$hcpen['ongberat']); ?>)</p>
                    </a>
                  </li>
            <?php } ?>
                  <!-- end message -->
...
<?php $vtan=mysqli_query($con,"SELECT * FROM service where jawab='' order by id_service desc ");$mtan=mysqli_num_rows($vtan); ?>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Toko Oleh Oleh</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  Toko Oleh Oleh - <?php echo $_SESSION['user']; ?>
                </p>
              </li>
              <!-- Menu Footer-->
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p>Toko Oleh Oleh - <?php echo $_SESSION['user']; ?></p>
