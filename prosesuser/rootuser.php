...
class user{
	...
	function insertcheckout($con,$id_checkout,$id_user,$an,$alamat,$phone,$ongcart,$ongberat,$tanggal){
		$sql=mysqli_query($con,"INSERT INTO checkout set id_checkout='$id_checkout',id_user='$id_user',an='$an',alamat='$alamat'/*,prov='$prov',kab='$kab',kec='$kec',kel='$kel',kodepos='$kodepos'*/,phone='$phone',ongcart='$ongcart',/*ongwil='$ongkirwil',*/ongberat='$ongberat',status='pending',tanggal='$tanggal' ");
		$tb=$ongcart+$ongberat;
	...
	function updatecheckout($con,$id_checkout,$id_user,$an,$alamat,$phone,$ongcart,$ongberat,$tanggal){
		$sql=mysqli_query($con,"UPDATE checkout set id_user='$id_user',an='$an',alamat='$alamat',/*prov='$prov',kab='$kab',kec='$kec',kel='$kel',kodepos='$kodepos',*/phone='$phone',ongcart='$ongcart'/*,ongwil='$ongkirwil'*/,ongberat='$ongberat',status='pending',tanggal='$tanggal' where id_checkout='$id_checkout' ");
		$tb=$ongcart+$ongberat;
